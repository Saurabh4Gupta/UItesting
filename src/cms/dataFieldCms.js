export const dataFieldCms = {
  ...
  delete: 'Delete',
  deletePopConfimationMessage:
    'Once deleted, this data request will no longer be available.',
  ...
  moveToCompleteDescription:
    'You will not be able to make any more edits to this request unless it is moved back to "Ongoing".',
